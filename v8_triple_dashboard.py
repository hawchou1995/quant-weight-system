...
auto_extra = [
    ...
    {"type": "text", "tab": "auto", "title": "分档配置表（资金 × TopN，数据说话）",
     "text": "- **≤10万 推荐 Top3**：单票3.3万 | +820% / 年化23.3% / 回撤-10.9% / 夏普1.71 / 17笔每年（低频省心）\n"
             "- **10-30万 推荐 Top5**：单票2-6万 | +600% / 年化20.1% / 回撤-10.2% / 夏普1.80 / 29笔每年\n"
             "- **30-100万 推荐 Top8**：单票4-12万 | +625% / 年化20.5% / 回撤-7.0% / 夏普2.06 / 46笔每年\n"
             "- **100万+ 推荐 Top10**：单票10万+ | +773% / 年化22.7% / 回撤-7.9% / 夏普2.34 / 57笔每年（夏普之王）\n"
             "- 关键发现：自动补位让资金档几乎无差异（同TopN下10万vs300万<1%）；夏普随TopN单调升——真正选择维度是交易频率\n"
             "- 任何资金都可跑任意档（引擎 cash0/top_n 参数化），按自己的频率偏好选档"},
