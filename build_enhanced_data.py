...
INDUSTRY = {
    ...
    '603989': '电子', '688143': '通信',
    # 普适版新选股票（按真实行业，2026-08-16 补全）
    '600353': '电子元件', '600397': '军工电子', '603002': '覆铜板',
    '300814': 'PCB', '300903': 'PCB', '301328': '连接器',
    '300907': '自动化设备', '300985': '汽车零部件', '301373': '环保设备',
    '301396': '软件开发', '301018': '空调设备', '300489': '半导体材料',
    '300566': '光学膜材料',
    '688300': '半导体材料', '688432': '半导体硅片', '688530': '电子化学品',
    '688392': '超声波设备', '688020': '电磁屏蔽', '688519': '覆铜板', '688167': '激光设备',
    # 普适版基金（按 akshare 类型）
    '000742': '混合型-灵活', '001060': '混合型-灵活', '001198': '混合型-灵活',
    '001411': '混合型-灵活', '001470': '混合型-灵活', '001723': '混合型-偏股',
    '001759': '混合型-灵活', '002051': '混合型-灵活', '002163': '混合型-灵活',
    '002289': '股票型',
    '020900': '指数型-通信',
}
BIZ = {
...
ETF_INDUSTRY = {
    ...
    '159703': '新材料', '159516': '半导体设备', '515880': '通信', '516150': '稀土',
    '159841': '证券', '560390': '电网设备',
}
...
for c in ALL_CODES:
    ...
    if not _industry:
        # 兜底：绝不显示"基金/股票"这类词——按名称推断或按板块给可读值
        _nm = FUND_NAMES.get(c, names.get(k, ""))
        if _board == "基金":
            _industry = "混合型" if ("混合" in _nm or "灵活" in _nm) else ("股票型" if "股票" in _nm else "场外基金")
        elif _board == "ETF":
            _industry = "指数型"
        else:
            _industry = "综合"
