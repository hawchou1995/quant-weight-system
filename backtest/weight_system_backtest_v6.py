...
输出：weight_system_v6_results.json（多实验对比）
"""
import pandas as pd
import numpy as np
import json
...
# ---------------------------------------------------------------------------
SECTOR_POOL = {
    "AI算力": [("300308", "中际旭创", "股票", "sz", None), ("600498", "烽火通信", "股票", "sh", None),
               ("002281", "光迅科技", "股票", "sz", None), ("300502", "新易盛", "股票", "sz", None),
               ("300394", "天孚通信", "股票", "sz", None), ("300570", "太辰光", "股票", "sz", None),
               ("603083", "剑桥科技", "股票", "sh", None), ("000988", "华工科技", "股票", "sz", None),
               ("002902", "铭普光磁", "股票", "sz", None), ("301205", "联特科技", "股票", "sz", None)],
    "半导体": [("688981", "中芯国际", "股票", "sh", None), ("002371", "北方华创", "股票", "sz", None),
               ("603501", "韦尔股份", "股票", "sh", None), ("603986", "兆易创新", "股票", "sh", None),
               ("300661", "圣邦股份", "股票", "sz", None), ("688008", "澜起科技", "股票", "sh", None),
               ("603290", "斯达半导", "股票", "sh", None), ("002185", "华天科技", "股票", "sz", None),
               ("002156", "通富微电", "股票", "sz", None), ("600584", "长电科技", "股票", "sh", None)],
    "PCB电子": [("002463", "沪电股份", "股票", "sz", None), ("600183", "生益科技", "股票", "sh", None),
                ("002384", "东山精密", "股票", "sz", None), ("603228", "景旺电子", "股票", "sh", None),
                ("002916", "深南电路", "股票", "sz", None), ("002938", "鹏鼎控股", "股票", "sz", None),
                ("300476", "胜宏科技", "股票", "sz", None), ("002815", "崇达技术", "股票", "sz", None),
                ("002913", "奥士康", "股票", "sz", None), ("603920", "世运电路", "股票", "sh", None)],
    "白酒食品": [("600519", "贵州茅台", "股票", "sh", None), ("000858", "五粮液", "股票", "sz", None),
                 ("000568", "泸州老窖", "股票", "sz", None), ("600809", "山西汾酒", "股票", "sh", None),
                 ("002304", "洋河股份", "股票", "sz", None), ("000596", "古井贡酒", "股票", "sz", None),
                 ("603369", "今世缘", "股票", "sh", None), ("600199", "金种子酒", "股票", "sh", None),
                 ("600702", "舍得酒业", "股票", "sh", None), ("600197", "伊力特", "股票", "sh", None)],
    "银行": [("601398", "工商银行", "股票", "sh", None), ("600036", "招商银行", "股票", "sh", None),
             ("601939", "建设银行", "股票", "sh", None), ("000001", "平安银行", "股票", "sz", None),
             ("601166", "兴业银行", "股票", "sh", None), ("600000", "浦发银行", "股票", "sh", None),
             ("600016", "民生银行", "股票", "sh", None), ("601169", "北京银行", "股票", "sh", None),
             ("601009", "南京银行", "股票", "sh", None), ("002142", "宁波银行", "股票", "sz", None)],
    "新能源": [("300750", "宁德时代", "股票", "sz", None), ("002594", "比亚迪", "股票", "sz", None),
               ("601012", "隆基绿能", "股票", "sh", None), ("300274", "阳光电源", "股票", "sz", None),
               ("300014", "亿纬锂能", "股票", "sz", None), ("002074", "国轩高科", "股票", "sz", None),
               ("002709", "天赐材料", "股票", "sz", None), ("300438", "鹏辉能源", "股票", "sz", None),
               ("600499", "科达制造", "股票", "sh", None), ("002407", "多氟多", "股票", "sz", None)],
    "医药": [("600276", "恒瑞医药", "股票", "sh", None), ("603259", "药明康德", "股票", "sh", None),
             ("300760", "迈瑞医疗", "股票", "sz", None), ("300122", "智飞生物", "股票", "sz", None),
             ("000661", "长春高新", "股票", "sz", None), ("600196", "复星医药", "股票", "sh", None),
             ("600436", "片仔癀", "股票", "sh", None), ("600557", "康缘药业", "股票", "sh", None),
             ("600566", "济川药业", "股票", "sh", None), ("603707", "健友股份", "股票", "sh", None)],
    "资源能源": [("601088", "中国神华", "股票", "sh", None), ("601899", "紫金矿业", "股票", "sh", None),
                 ("601225", "陕西煤业", "股票", "sh", None), ("600188", "兖矿能源", "股票", "sh", None),
                 ("000983", "山西焦煤", "股票", "sz", None), ("603993", "洛阳钼业", "股票", "sh", None),
                 ("600111", "北方稀土", "股票", "sh", None), ("600489", "中金黄金", "股票", "sh", None),
                 ("600392", "盛和资源", "股票", "sh", None), ("600988", "赤峰黄金", "股票", "sh", None)],
    "消费": [("600887", "伊利股份", "股票", "sh", None), ("603288", "海天味业", "股票", "sh", None),
             ("000333", "美的集团", "股票", "sz", None), ("002714", "牧原股份", "股票", "sz", None),
             ("000895", "双汇发展", "股票", "sz", None), ("000651", "格力电器", "股票", "sz", None),
             ("600690", "海尔智家", "股票", "sh", None), ("000848", "承德露露", "股票", "sz", None),
             ("600597", "光明乳业", "股票", "sh", None), ("002216", "三全食品", "股票", "sz", None)],
    "已退市": [("300104", "乐视网", "股票", "sz", None), ("300431", "暴风集团", "股票", "sz", None),
               ("600518", "康美药业", "股票", "sh", None), ("000979", "中弘股份", "股票", "sz", None),
               ("002477", "雏鹰农牧", "股票", "sz", None), ("002680", "长生生物", "股票", "sz", None),
               ("000693", "华泽钴镍", "股票", "sz", None), ("300216", "千山药机", "股票", "sz", None),
               ("300028", "金亚科技", "股票", "sz", None), ("601558", "ST锐电", "股票", "sh", None)],
}
...
# 1. 数据加载（与 v2 一致）
# ---------------------------------------------------------------------------
DATA_V2_DIR = os.path.join(BASE_DIR, "data_v2")  # wind 通道 2016 起全量数据

def load_data(code: str) -> pd.DataFrame:
    for d in (DATA_V2_DIR, DATA_TMP_DIR, DATA_DIR):  # v2 优先（2021 起全量，避免旧数据遮蔽）
    ...
    raise FileNotFoundError(f"{code}.csv not found in data/ data_tmp/ data_v2/")
...
def run_backtest(df, news_level, market_state=None, bb_coef=None, weights=None, strategy="weight", fg_state=None):
    ...
    for i in range(len(d)):
        ...
        # 停牌日（volume=0）：跳过信号生成与执行，持有状态延续
        suspended = (row["volume"] is not None and not pd.isna(row["volume"]) and row["volume"] <= 0)
        ...
        if pending_action is not None and in_eval:
            ...
            pending_action = None
            # 退市/停牌极端价格保护：open<=0 或价低于 0.01 元时跳过执行（防除零/溢出）
            if open_p <= 0 or open_p < 0.01:
                continue
            if action == "buy":
        ...
        if in_eval and indicators_ready and not suspended:
            if strategy == "weight":
...
def main():
    ...
    with open("weight_system_v6_results.json", "w", encoding="utf-8") as f:
        json.dump(out, f, ensure_ascii=False, indent=2)
    print("\n已输出 weight_system_v6_results.json")
