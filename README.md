...
- **滑点/冲击成本已建模**（sweep_slip.py 敏感性扫描，每边 bps）：股票 10/20/30bps → +462%/+331%/+231%（夏普 1.99/1.69/1.39）｜ ETF 10bps → +162% ｜ **基金 30bps 申赎费下 +273%→+11% 归零——场外基金短线必须用 C 类份额（0 申赎费）**；佣金万2.5 + 印花税万5 已含
